...
export const ISL_CONFIG: ISLConfig = {
  ...
  clientProfile: {
    ...
    bio: "I'm a leadership coach, researcher, and practitioner whose work has shaped schools and districts across the country. Author of 'Equity Traps and Tropes' and co-author of 'Street Data' (Corwin Press). Ed.D. UC Berkeley, national speaker.",
    existingAssets: [
