...
const T = {
  ...
  glass: "rgba(0, 0, 0, 0.02)", // very subtle
  glassBorder: "rgba(0, 0, 0, 0.05)",
  glassHover: "rgba(0, 0, 0, 0.04)",
  glassBright: "rgba(0, 0, 0, 0.03)",
  textPrimary: "#4A4A4A", // softer charcoal
  textSecondary: "#3D3D3D", // headings
  textTertiary: "#8B8B8B", // muted text
  pink: "#E8548C", // keep existing
  pinkGlow: "rgba(232, 84, 140, 0.15)",
  pinkBorder: "rgba(232, 84, 140, 0.25)",
  cyan: "#7ECBC4", // soft pastel teal (primary)
  cyanGlow: "rgba(126, 203, 196, 0.15)",
  cyanBorder: "rgba(126, 203, 196, 0.25)",
  gold: "#FFD93D", // keep existing
...
export default function ISLPitchDeck() {
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <div style={{ marginBottom: 30 }}>
            <Mail size={48} style={{ color: T.cyan, marginBottom: 20 }} />
          </div>
          <h2 style={{ 
            fontSize: "2.2rem", 
            fontWeight: 700, 
            ...
            Free Download: 7-Layer IP Architecture Audit
          </h2>
          <p style={{ 
            fontSize: "1.1rem", 
            margin: "0 0 40px", 
            ...
            Get your 9-page PDF guide to audit your intellectual property architecture and identify protection opportunities.
          </p>
          ...
          <form style={{ 
            ...
            <button
              type="submit"
              style={{
                background: `linear-gradient(135deg, ${T.cyan}, #6BB8B0)`,
                color: "white",
                border: "none",
                padding: "15px 30px",
                borderRadius: 50,
      ...
      {/* ═══════════════════════════════════════════════════════════════════════
          EMAIL CAPTURE 2: WAITLIST
      ═══════════════════════════════════════════════════════════════════════ */}
      <section style={{ padding: "80px 20px", background: T.bgPrimary }}>
        <GlassCard
          style={{
            maxWidth: 800,
            margin: "0 auto",
        ...
        >
          ...
          <p style={{ 
            ...
            Get immediate access to the 7-Layer IP Architecture Audit, plus be the first to know when the full course opens.
          </p>
